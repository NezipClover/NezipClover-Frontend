...
<template>
  ...
  <VCard style="position: absolute; width : 30% ; margin-top : 50px; z-index: 3; margin-left :50%  "
  color="white"
  elevation="3"
  ...
  >
    ...
    <tbody v-else>
      ...
      >
        <td>{{ item.no }}</td>
        <td class="text-center" v-if="item.type==1">
          매매
        </td>
        <td class="text-center" v-else-if="item.type==2">
          전세
        </td>
        <td class="text-center" v-else-if="item.type==3">
          월세
        </td>
